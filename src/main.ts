...
cubeTextureUrls = generateCubeUrls('/cubeMap1/', '.png');
...
const octahedron = new THREE.OctahedronGeometry(3, 1);
const ring = new THREE.RingGeometry(1, 5, 32);

// Create tennis racket geometry
const racketHead = new THREE.TorusGeometry(3.7, 0.5, 16, 32);
const racketHandle = new THREE.BoxGeometry(0.8, 8, 0.8);
racketHandle.applyMatrix4(new THREE.Matrix4().makeTranslation(0, -8, 0));
const tennisRacketGeo = mergeGeometries([racketHead, racketHandle]);
